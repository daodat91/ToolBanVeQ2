...
namespace DAL.ManageDocument.FactoryClasses
{
	...
	{
		private static readonly Dictionary<DAL.ManageDocument.EntityType, string> _entityTypeNamesCache = new Dictionary<DAL.ManageDocument.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(DAL.ManageDocument.EntityType value in Enum.GetValues(typeof(DAL.ManageDocument.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(DAL.ManageDocument.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(DAL.ManageDocument.EntityType relatedEntityType)
		{
