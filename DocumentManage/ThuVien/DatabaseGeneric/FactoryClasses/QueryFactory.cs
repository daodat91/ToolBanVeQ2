...
namespace DAL.ManageDocument.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the CauHinh entity</summary>
		public EntityQuery<CauHinhEntity> CauHinh
		{
			get { return Create<CauHinhEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the ChuyenVien entity</summary>
		public EntityQuery<ChuyenVienEntity> ChuyenVien
		{
			get { return Create<ChuyenVienEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the CongTyDoVe entity</summary>
		public EntityQuery<CongTyDoVeEntity> CongTyDoVe
		{
			get { return Create<CongTyDoVeEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the Huyen entity</summary>
		public EntityQuery<HuyenEntity> Huyen
		{
			get { return Create<HuyenEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the LoaiBienDong entity</summary>
		public EntityQuery<LoaiBienDongEntity> LoaiBienDong
		{
			get { return Create<LoaiBienDongEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the LoaiGiayTo entity</summary>
		public EntityQuery<LoaiGiayToEntity> LoaiGiayTo
		{
			get { return Create<LoaiGiayToEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the NguoiDung entity</summary>
		public EntityQuery<NguoiDungEntity> NguoiDung
		{
			get { return Create<NguoiDungEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the ThongTinHoSo entity</summary>
		public EntityQuery<ThongTinHoSoEntity> ThongTinHoSo
		{
			get { return Create<ThongTinHoSoEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the Tinh entity</summary>
		public EntityQuery<TinhEntity> Tinh
		{
			get { return Create<TinhEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the Xa entity</summary>
		public EntityQuery<XaEntity> Xa
		{
			get { return Create<XaEntity>(); }
		}
